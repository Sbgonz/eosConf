...
setopt HIST_IGNORE_ALL_DUPS # Do not write duplicates in the history, lines matching the current line are removed
...
bindkey '\e[3~' delete-char  #changed by sbg, Orig '^[[P'
